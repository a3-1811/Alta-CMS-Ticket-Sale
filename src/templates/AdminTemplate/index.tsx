    ...
    <div className='template container min-h-screen mx-auto pt-[17px] pb-8 px-8 bg-dashboard-background rounded-3xl'>
      <div className="wrapper flex relative">
        <div className="flex flex-col nav w-[13.5%] h-full bg-red lg:w-1/5 md:hidden ">
          <Link to='/' className='2xl:w-[100px]'><img src="/images/logo.svg" alt="logo" /></Link>
          <ul  className='mt-[59px] flex flex-col gap-y-2 flex-1'>
            <NavLink to='/' className='block w-full py-[15px] pl-[27px] xl:pl-[10px] 2xl:py-2 2xl:pl-3'>
              <li className='flex items-center gap-x-[15px] text-lg 3xl:text-sm 2xl:text-xs' ><HomeIcon className='w-[20px]'/> Trang chủ</li>
            </NavLink>
            <NavLink to='/manager-ticket' className='block w-full py-[15px] pl-[27px] xl:pl-[10px] 2xl:py-2 2xl:pl-3 '>
              <li className='flex items-center gap-x-[15px] text-lg 3xl:text-sm 2xl:text-xs'><TicketIcon className='w-[20px]'/> Quản lý vé</li>
            </NavLink>
            <NavLink to='/checking-ticket' className='block w-full py-[15px] pl-[27px] xl:pl-[10px] 2xl:py-2 2xl:pl-3 '>
           ...
           <div className='w-full flex items-center flex-col'>
            <NavLink to='/ticket-package' className='cursor-pointer w-full py-[15px] pl-[27px] xl:pl-[10px] 2xl:py-2 2xl:pl-3'>
          ...
          <span className='absolute bottom-0 left-0 text-sm mt-auto 2xl:text-[8px]'>Copyright &copy; 2020 Alta Software </span>
        </div>
        <div className="content w-[84.4%] bg-blue ml-9 lg:w-4/5 md:w-full md:ml-0 relative">
          ...
          <div className="w-full flex items-center mb-[20px]">
            ...
            <div className="shrink-0 flex items-center min-w-[144px] gap-x-6 ml-auto md:justify-center">
              <img src="/images/icons/mail.svg" alt="mail" className='cursor-pointer 2xl:w-[15px]'/>
              <img src="/images/icons/bell.svg" alt="bell" className='cursor-pointer 2xl:w-[15px]'/>
              <div className="avatar rounded-full h-[48px] w-[48px]  2xl:h-[35px] 2xl:w-[35px] cursor-pointer shrink-0">
          ...
          <ul  className='mt-[59px] flex flex-col gap-y-2 '>
            <NavLink to='/' className='w-full py-[15px] pl-[27px] xl:pl-[10px] 2xl:py-2 2xl:pl-3'>
              <li className='flex items-center gap-x-[15px] text-lg 3xl:text-sm 2xl:text-xs' ><HomeIcon className='w-[20px]'/> Trang chủ</li>
            </NavLink>
            <NavLink to='/manager-ticket' className='w-full py-[15px] pl-[27px] xl:pl-[10px]  2xl:py-2 2xl:pl-3'>
              <li className='flex items-center gap-x-[15px] text-lg 3xl:text-sm 2xl:text-xs'><TicketIcon className='w-[20px]'/> Quản lý vé</li>
            </NavLink>
            <NavLink to='/checking-ticket' className='w-full py-[15px] pl-[27px] xl:pl-[10px]  2xl:py-2 2xl:pl-3'>
              <li className='flex items-center gap-x-[15px] text-lg 3xl:text-sm 2xl:text-xs'><i className="fas fa-file-invoice"></i>Đối soát vé</li>
            </NavLink>
           <div className='w-full flex items-center flex-col'>
            <NavLink to='/ticket-package' className='cursor-pointer w-full py-[15px] pl-[27px] xl:pl-[10px] 2xl:py-2 2xl:pl-3'>
